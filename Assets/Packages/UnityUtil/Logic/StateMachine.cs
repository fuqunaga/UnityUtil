...
namespace UnityUtil
{
    ...
    {
        protected T _script;
        protected GameObject gameObject { get { return _script.gameObject; } }
        protected Transform transform { get { return _script.transform; } }


        public StateWithMonoBehaviour<T> Init(T script) { _script = script; return this; }
    }
}